...
import 'package:gamentic/resources/game_screenshots.dart';
...
class Repository{
  ...
  final _gameScreenShots = new GameScreenShotsProviderAPI();
  ...
  Future<GameScreenShotsModel> fetchGameScreenShots(int id) => _gameScreenShots.getGameScreenShots(id);
